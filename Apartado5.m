...
CL_alpha= CL1/(deg2rad(5));

for i=1:N
Cla(i)=(Cly1(i)-Cly2(i))/(CL1-CL2);
end

for i=1:N
Clb(i)=Cly1(i)-(Cla(i)*CL1);
end

sumaCla=0;
sumaClb=0;
for i=1:N
suma1=(1/S)*Cla(i)*chord3(i)*(1/N)+sumaCla;
sumaCla=suma1;
suma2=(1/S)*Clb(i)*chord3(i)*(1/N)+sumaClb;
sumaClb=suma2;
end
