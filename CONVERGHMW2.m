...
X=1:2:250;
figure
plot(X,CLc,'b','DisplayName','CL');
xlabel('Number of panels N','interpreter','latex');
title('Grid convergence of the numerical results','interpreter','latex');
hold on;
plot(X,CMlec,'r','DisplayName','CMle');
plot(X,CDic,'g','DisplayName','CDi');
legend('show');